...
MelodyTones = [ 'fis\'8.', 'a8.', 'd\'8.', 'b8.',
                ...
                'e\'8.','g8.','c\'8.','as8.',
                'as,8.','h8.','e\'\'8.','c\'\'8.' ]
BassTones = [ 'h\'16', 'e16', 'c16' , 'd16', 'h,16', 'e\'16', 'c16' ]

n = BassTones[0]
for m in itertools.islice(MelodyTones, 0, 4):
    print('r4','r8','r16','a16','r16',m,'r8','r16',n,'|','r2','r4','r8','r16','a\'16','|','r16',m,'r8','r16',n,'r2','|')
...
for m in itertools.islice(MelodyTones, 8, 12):
    print('r4','r8','r16','a16','r16',m,'r8','r16',n,'|','r2','r4','r8','r16','a16','|','r16',m,'r8','r16',n,'r2','|')
